...
const AllDonations = () => {
    ...
    useEffect(()=>{
        axios.get('http://localhost:5001/donation/allDonation')
        .then(res => {
    ...
    const handleDelete = (id) =>{
            ...
            axios
            .delete('http://localhost:5001/donation/deleteDonation/'+id)
            ...
            <table style={{ borderCollapse: 'collapse', width: '100%' }}>
                <thead>
                    <tr style={{ backgroundColor: 'orange', color: 'white' }}>
                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>Donation ID</th>
                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>Full Name</th>
                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>Email</th>
                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>Address</th>
                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>Donation Type</th>
                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>Amount</th>
                        <th style={{ padding: '8px', border: '1px solid #ddd' }}>Slip</th>
